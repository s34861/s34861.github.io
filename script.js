...
document.addEventListener("DOMContentLoaded", function () {
    ...
    new Chart(ctx, {
        type: 'radar',
        data: {
            labels: ['อังกฤษ', 'วิทยาศาสตร์', 'ภาษาไทย', 'คณิตศาสตร์', 'สังคมศึกษา'],
            datasets: [{
                data: [67, 62, 58, 60, 43], // ค่า Stat % ตามวิชาจริงของคุณ
                backgroundColor: 'rgba(168, 15, 20, 0.65)', // สีแดงเข้มโปร่งแสง
                borderColor: '#c91820', // เส้นขอบสีแดงสด/เข้ม
                borderWidth: 2,
        ...
        options: {
            ...
            scales: {
                r: {
                    ...
                    grid: { color: 'rgba(255, 255, 255, 0.25)' }, // เส้นใยแมงมุมสีขาวอ่อน
                    angleLines: { color: 'rgba(255, 255, 255, 0.3)' },
                    pointLabels: {
                        color: '#f5d061', // สีตัวหนังสือชื่อวิชา (สีทอง TOTY)
                        font: { family: 'Kanit', size: 11, weight: 'bold' }
                    }
                }
            },
            plugins: {
                legend: { display: false } // ซ่อนคำอธิบาย Dataset
            }
        }
    });
});
